...
const { issueCaptcha, sendContact } = require('./contact');
...
// Public (pas de token launcher : c'est un navigateur qui appelle ceci, pas le launcher). Pensez a ajouter
// l'origine de votre site a CORS_ORIGINS si vous utilisez ce formulaire depuis un navigateur.
app.get('/contact/captcha', rateLimit(30, 60_000), issueCaptcha);
app.post('/contact', rateLimit(5, 60_000), sendContact);
