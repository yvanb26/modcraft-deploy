...
// liste : systeme d'assets/dossier de jeu different (bucket "pre-1.6"), pas
// fiable sur toutes les machines : on prefere ne pas les proposer aux
// serveurs plutot que de mal les supporter. On compare par date de sortie
// reelle (pas par numero de version, peu fiable a trier tel quel) par
// rapport a la sortie de 1.6.
